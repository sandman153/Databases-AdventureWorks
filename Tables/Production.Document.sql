...
[FileExtension] [nvarchar] (8) COLLATE Latin1_General_CI_AS NOT NULL,
[Revision] [nchar] (5) COLLATE Latin1_General_CI_AS NOT NULL,
[ChangeNumber] [int] NOT NULL CONSTRAINT [DF_Document_ChangeNumber] DEFAULT ((0)),
[Status] [tinyint] NOT NULL,
[DocumentSummary] [nvarchar] (max) COLLATE Latin1_General_CI_AS NULL,
...
GO
ALTER TABLE [Production].[Document] ADD CONSTRAINT [UQ__Document__F73921F78BE8D685] UNIQUE NONCLUSTERED  ([rowguid]) ON [PRIMARY]
GO
